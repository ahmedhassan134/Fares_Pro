...
'''),
                  ...
                  SubDomain(text: '''-	تقع في الجزء الخلفي للفص الصدغي أمام منطقة فيرنك 
...
'''),
                  ...
                  SubDomain(text: 'يحتوي على خلايا القشرة المخية المسئولة عن الإحساس السعي وعملية الاستماع وفهم الكلام المسموع')
                ],
              ),
            ),
          )
